        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Experience the future of fitness with our advanced AI technology. Simplify your training, optimize your results, and elevate your fitness journey with our innovative app.</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              {/* <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Button href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out" onClick={() => setModalOpen(!modalOpen)}>Web Studio</Button>
                  </li>
                  <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Fitflux.ai All rights reserved.</div>
